        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.containerItems}>
                    ...
                    <View style={styles.inputContainer}>
                        <Icon name={showPassword ? "lock-open" : "lock-closed"} size={24} color="#E1A500" style={styles.icon} />
                        <TextInput
                            style={styles.input}
                ...
                <TouchableOpacity style={styles.backButton} onPress={handleLogin}>
                    <Icon name="arrow-back" size={24} color="#000" style={styles.backButtonIcon} />
                </TouchableOpacity>
                ...
                <View style={styles.containerItems}>
                    ...
                    {loading && (
                        <ActivityIndicator style={styles.progressBar} size="large" color="#E1A500" />
                    )}
